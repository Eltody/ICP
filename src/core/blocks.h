...
const std::map<BlockType, std::string> BLOCK_NAME = {
    ...
    { VECTOR_MUL_CONST, "2D Vektorové násobenie konštantou"},
    { VECTOR_MUL_CONST3D, "3D Vektorové násobenie konštantou"},

    // Matrix
    { MAT2_INPUT, "Maticový vstup" },
    { MAT3_INPUT, "Maticový vstup" },
    { MAT_DETERMINANT_INPUT, "Maticový vstup (pre determinant)" },
    ...
    { MAT_DETERMINANT, "Výpočet determinantu matice"},
